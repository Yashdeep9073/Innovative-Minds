...
import { 
  User, Compass, LayoutDashboard, Briefcase, GraduationCap, Globe, 
  Library, ShieldCheck, PenTool, Zap, BarChart, Phone, Layers, 
  Users as UsersIcon, Star, Folder, BadgeCheck, HelpCircle, 
...
export const StudentsPage: React.FC<{ onNavigate: (p: string) => void }> = ({ onNavigate }) => {
   ...
   <div className="font-inter bg-gray-50 text-gray-800">
      <SEO 
        title="Student Life & Community | Innovative Minds Institute"
        description="Join a vibrant community of innovators at Africa's leading EdTech hub. From virtual hackathons to local meetups in Lusaka and beyond."
        keywords="Student Community Africa, EdTech Zambia, Online Learning Support, Innovative Minds Institute Students"
        url="https://iminstitute.online/students"
      />
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
               <div className="flex-1 animate-in slide-in-from-left-10 duration-700 text-center md:text-left">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-100 text-red-800 text-xs font-bold mb-4 md:mb-6">
                     <UsersIcon size={14} /> IMI Student Community | LUSAKA, ZAMBIA
                  </div>
                  ...
                  <p className="text-base md:text-lg text-gray-600 mb-6 md:mb-8 leading-relaxed">
                     More than just online courses, IMI offers a vibrant community of innovators. From virtual hackathons to local meetups, discover how our students are shaping the future of Africa and the world.
                  </p>
