...
export const LibraryPage: React.FC<{ onNavigate: (p: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="font-inter bg-gray-50 text-gray-800">
      <SEO 
        title="Digital Library | Innovative Minds Institute"
        description="Access a world of ideas, peer-reviewed journals, and global research. Powered by Gemini AI to summarize, translate, and explain complex topics instantly."
        keywords="Digital Library Africa, AI Research Tools, Online Journals Zambia, Innovative Minds Institute Library"
        url="https://iminstitute.online/library"
      />
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl px-4 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 border border-white/30 rounded-full bg-white/10 backdrop-blur-md">
             ...
             <span className="text-white font-mono text-sm tracking-widest uppercase">LUSAKA, ZAMBIA | GLOBAL REACH</span>
          </div>
