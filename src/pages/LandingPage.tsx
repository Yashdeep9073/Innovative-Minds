...
export const LandingPage: React.FC<{ onNavigate: (p: string) => void }> = ({ onNavigate }) => {
  ...
  const renderCatalogSection = (title: string, typeFilter: string) => {
    ...
    const items = workshops.filter(w => w.category === typeFilter).slice(0, 10);
  ...
  return (
    <div className="font-inter bg-white text-gray-800 overflow-x-hidden">
      <SEO 
        title="Innovative Minds Institute | Africa's Global EdTech Hub"
        description="Empowering the next generation of African leaders through AI-driven, solar-powered, and accessible digital learning. Join 15,000+ learners globally."
        keywords="EdTech Africa, Online Learning Zambia, AI Education, Digital Literacy, Scholarships Africa, Innovative Minds Institute"
        schema={{
          ...
          "description": "A global leader in AI-powered education, headquartered in Lusaka, Zambia.",
          "address": {
            "@type": "PostalAddress",
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center bg-gray-900 text-white overflow-hidden py-16 md:py-0">
        <div className="absolute inset-0">
           <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2070" className="w-full h-full object-cover opacity-30" alt="Global Education" referrerPolicy="no-referrer" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center animate-in fade-in zoom-in duration-700 flex flex-col items-center">
           <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-6 md:mb-8 hover:bg-white/20 transition-colors cursor-default mt-8 md:mt-0">
              ...
              <span className="text-xs font-bold tracking-widest uppercase">
                {APP_VERSION_LABEL} {APP_VERSION} | LUSAKA, ZAMBIA
              </span>
           </div>
           <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 leading-tight tracking-tight drop-shadow-2xl">
              Africa's Global <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D62828] via-orange-500 to-yellow-500">EdTech Hub</span>
           </h1>
           <p className="text-lg md:text-2xl text-gray-200 mb-10 md:mb-12 max-w-3xl mx-auto font-light leading-relaxed drop-shadow-md px-2">
              Empowering the next generation of African leaders through AI-driven, solar-powered, and accessible digital learning. Join 15,000+ learners globally.
           </p>
      ...
      {/* NEW SECTION: FREE PERSONALISED TUITIONS */}
