...
export const AboutUsPage: React.FC<{ onNavigate: (p: string) => void }> = ({ onNavigate }) => {
  ...
  return (
    <div className="font-inter bg-white text-gray-800 overflow-x-hidden">
      <SEO 
        title="About Innovative Minds Institute | Africa's Premier EdTech Hub"
        description="Headquartered in Lusaka, Zambia, Innovative Minds Institute is transforming education across Africa and the globe with AI-driven, accessible learning."
        keywords="About Innovative Minds Institute, EdTech Africa, Online Learning Zambia, AI Education, Digital Literacy, Scholarships Africa"
        url="https://iminstitute.online/about-us"
      />
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl px-4 animate-in fade-in slide-in-from-bottom-10 duration-1000">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 border border-red-500/50 rounded-full bg-red-900/20 backdrop-blur-md">
             ...
             <span className="text-red-100 font-mono text-xs tracking-widest uppercase">LUSAKA, ZAMBIA | GLOBAL REACH</span>
          </div>
          <h1 className="text-5xl md:text-8xl font-black text-white mb-6 tracking-tight leading-tight">
            Africa's Global <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D62828] to-orange-500">EdTech Hub</span>
          </h1>
